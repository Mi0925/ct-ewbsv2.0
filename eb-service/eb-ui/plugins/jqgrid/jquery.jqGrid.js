	...
	styleUI : {
		...
		Bootstrap : {
			...
			colmenu : {
				...
				icon_menu : "glyphicon-resource-hamburger",
				...
				icon_toolbar_menu : "glyphicon-resource-hamburger"
			}
		},
		Bootstrap4 : {
			common : {
...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		buildColItems = function (top, left, parent) {
			...
			str1 = '<ul id="col_menu" class="ui-search-resource  ui-col-resource modal-content" role="resource" tabindex="0" style="left:'+left+'px;">';
			for(i=0;i<len;i++) {
				...
				str1 += '<li '+disp+' class="ui-resource-item" role="presentation" draggable="true"><a class="g-resource-item" tabindex="0" role="menuitem" ><table class="ui-common-table" ><tr><td class="menu_icon" title="'+texts.reorder+'"><span class="'+iconbase+' '+colmenustyle.icon_move+' notclick"></span></td><td class="menu_icon"><input class="'+colmenustyle.input_checkbox+'" type="checkbox" name="'+nm+'" '+hid+'></td><td class="menu_text">'+lb+'</td></tr></table></a></li>';
				cols.push(i);
			}
			str1 += "</ul>";
			$(parent).append(str1);
			$("#col_menu").addClass("ui-resource " + colmenustyle.menu_widget);
		...
		buildSearchBox = function (index, top, left, parent) {
			...
			//elem = $('<ul id="search_menu" class="ui-search-resource modal-content" role="resource" tabindex="0" style="left:'+left+'px;top:'+top+'px;"></ul>');
			elem = $('<form></form>');
			...
			str1 += "</div>";
			elem.append(str1);
			elem = $('<li class="ui-resource-item" role="presentation"></li>').append( elem );
			elem = $('<ul id="search_menu" class="ui-search-resource modal-content" role="resource" tabindex="0" style="left:'+left+'px;"></ul>').append(elem);
			$(parent).append(elem);
			$("#search_menu").addClass("ui-resource " + colmenustyle.menu_widget);
		...
		buildColMenu = function( index, left, top ){
			...
			var strb = '<ul id="column_menu" role="resource" tabindex="0">',
			str = '',
			stre = "</ul>",
			strl ='',
			...
			menuData.push( str );
			if(op.sorting) {
				str = '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_sort_asc+'"></span></td><td class="menu_text">'+texts.sortasc+'</td></tr></table></a></li>';
				str += '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_sort_desc+'"></span></td><td class="menu_text">'+texts.sortdesc+'</td></tr></table></a></li>';
				menuData.push( str );
			}
			if(op.columns) {
				str = '<li class="ui-resource-item divider" role="separator"></li>';
				str += '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_columns+'"></span></td><td class="menu_text">'+texts.columns+'</td></tr></table></a></li>';
				menuData.push( str );
			}
			if(op.filtering) {
				str = '<li class="ui-resource-item divider" role="separator"></li>';
				str += '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_filter+'"></span></td><td class="menu_text">'+texts.filter + ' ' + label +'</td></tr></table></a></li>';
				menuData.push( str );
			}
			if(op.grouping) {
				isgroup = $.inArray(cm.name, ts.p.groupingView.groupField);
				str = '<li class="ui-resource-item divider" role="separator"></li>';
				str += '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_group+'"></span></td><td class="menu_text">'+(isgroup !== -1 ?  texts.ungrouping: texts.grouping + ' ' + label)+'</td></tr></table></a></li>';
				menuData.push( str );
			}
			if(op.freeze) {
				isfreeze = (cm.frozen && ts.p.frozenColumns) ? false : true;
				str = '<li class="ui-resource-item divider" role="separator"></li>';
				str += '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+colmenustyle.icon_freeze+'"></span></td><td class="menu_text">'+(isfreeze ? (texts.freeze + " "+ label) : texts.unfreeze)+'</td></tr></table></a></li>';
				menuData.push( str );
			}
			for( var key in ts.p.colMenuCustom) {
				if(ts.p.colMenuCustom.hasOwnProperty(key)) {
					...
					if( menuitem.colname === cname  || (menuitem.colname === '_all_' && $.inArray(cname, exclude) === -1)) {
						strl = '<li class="ui-resource-item divider" role="separator"></li>';
						str = '<li class="ui-resource-item" role="presentation"><a class="g-resource-item" tabindex="0" role="menuitem" data-value="'+menuitem.id+'"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+iconbase+' '+menuitem.icon+'"></span></td><td class="menu_text">'+menuitem.title+'</td></tr></table></a></li>';
			...
			$("#column_menu")
				.addClass("ui-search-resource modal-content column-resource jqgrid-column-resource ui-resource " + colmenustyle.menu_widget)
...
///// toolbar resource
		if( ts.p.menubar === true) {
			...
			var arf1 = '<ul id="'+ts.p.id+'_menubar" class="ui-search-resource modal-content column-resource ui-resource jqgrid-caption-resource ' + colmenustyle.menu_widget+'" role="menubar" tabindex="0"></ul>';
		...
		return this.each(function(){
			...
			if( $.isArray(items)) {
				for(var i = 0; i < items.length; i++) {
					...
					str = '<li class="ui-resource-item" role="presentation"><a id="'+ item.id+'" class="g-resource-item" tabindex="0" role="menuitem" ><table class="ui-common-table"><tr><td class="menu_icon">'+ico+'</td><td class="menu_text">'+item.title+'</td></tr></table></a></li>';
					}
	...
	filterToolbar : function(p){
		...
		return this.each(function(){
			...
			buildRuleMenu = function( elem, left, top ){
				...
				var fs =  $('.ui-jqgrid').css('font-size') || '11px';
				var str = '<ul id="sopt_menu" class="ui-search-resource modal-content" role="resource" tabindex="0" style="font-size:'+fs+';left:'+left+'px;top:'+top+'px;">',
				...
				for ( i = 0 ; i < options.sopt.length; i++) {
					...
					if(ina !== -1) {
						...
						str += '<li class="ui-resource-item '+selclass+'" role="presentation"><a class="'+ common.cornerall+' g-resource-item" tabindex="0" role="menuitem" value="'+p.odata[ina].oper+'" oper="'+p.operands[p.odata[ina].oper]+'"><table class="ui-common-table"><tr><td width="25px">'+p.operands[p.odata[ina].oper]+'</td><td>'+ p.odata[ina].text+'</td></tr></table></a></li>';
					}
				}
				str += "</ul>";
				$('body').append(str);
				$("#sopt_menu").addClass("ui-resource " + classes.menu_widget);
		...
		return this.each(function() {
			...
			if (findnav) {
				...
				if (findnav) {
					...
					item = $('<li class="ui-resource-item" role="presentation"><a class="'+ cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.caption || p.title)+'</a></li>');
					if(id) {
						if(p.position === 'first') {
							$("#"+id).prepend( item );
						} else {
	...
	navSeparatorAdd:function (elem,p) {
		...
		return this.each(function() {
			...
			if(findnav) {
				...
				findnav = $(".dropdownmenu",elem)[0];
				sep = "<li class='ui-resource-item " +commonstyle.disabled + "' style='width:100%' role='presentation'><hr class='ui-separator-li'></li>";
				if(findnav) {
					id = $(findnav).val();
					if(id) {
						if(p.position === "first") {
	...
	_buildNavMenu : function ( elem, elemids, p, pEdit, pAdd, pDel, pSearch, pView ) {
		return this.each(function() {
			...
			_buildMenu = function() {
				var fs =  $('.ui-jqgrid').css('font-size') || '11px',
				eid, itm,
				str = $('<ul id="'+mid+'" class="ui-nav-resource modal-content" role="resource" tabindex="0" style="display:none;font-size:'+fs+'"></ul>');
				if( p.add ) {
					pAdd = pAdd || {};
					eid = pAdd.id || "add_"+elemids;
					itm = $('<li class="ui-resource-item" role="presentation"><a class="'+ commonstyle.cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.addtext || p.addtitle)+'</a></li>').click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
				...
				if( p.edit ) {
					...
					itm = $('<li class="ui-resource-item" role="presentation"><a class="'+ commonstyle.cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.edittext || p.edittitle)+'</a></li>').click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
							var sr = $t.p.selrow;
							if (sr) {
				...
				if( p.view ) {
					...
					itm = $('<li class="ui-resource-item" role="presentation"><a class="'+ commonstyle.cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.viewtext || p.viewtitle)+'</a></li>').click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
							var sr = $t.p.selrow;
							if (sr) {
								if($.isFunction( p.editfunc ) ) {
				...
				if( p.del ) {
					...
					itm = $('<li class="ui-resource-item" role="presentation"><a class="'+ commonstyle.cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.deltext || p.deltitle)+'</a></li>').click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
							var dr;
							if($t.p.multiselect) {
								dr = $t.p.selarrrow;
				...
				if(p.add || p.edit || p.del || p.view) {
					$(str).append("<li class='ui-resource-item " +commonstyle.disabled + "' style='width:100%' role='presentation'><hr class='ui-separator-li'></li>");
				}
				if( p.search ) {
					pSearch = pSearch || {};
					eid = pSearch.id || "search_"+elemids;
					itm = $('<li class="ui-resource-item" role="presentation"><a class="'+ commonstyle.cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.searchtext || p.searchtitle)+'</a></li>').click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
				...
				if( p.refresh ) {
					eid = pSearch.id || "search_"+elemids;
					itm = $('<li class="ui-resource-item" role="presentation"><a class="'+ commonstyle.cornerall+' g-resource-item" tabindex="0" role="menuitem" id="'+eid+'">'+(p.refreshtext || p.refreshtitle)+'</a></li>').click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
				...
				$(str).hide();
				$('body').append(str);
				$("#"+mid).addClass("ui-resource " + classes.menu_widget);
				$("#"+mid+" > li > a").hover(
					function(){ $(this).addClass(commonstyle.hover); },
					function(){ $(this).removeClass(commonstyle.hover); }
				);
