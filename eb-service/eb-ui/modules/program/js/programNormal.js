...
var vm = new Vue({
    ...
    methods:{
        ...
        initLayDate: function () {
            ...
            vm.programInfo.programStrategy.playTime = thisCDate;
...
//校验节目策略
function checkStrategy(programType){
	if(programType=='1'){
...
function addProgramTime(obj) {
    ...
    if(vm.timeStyle == 1){
        ...
        durationTime = durationTime.replace(/\b(0+)/gi,"");
