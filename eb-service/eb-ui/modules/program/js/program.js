$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL+'safeRest/program/page',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
    ...
    mounted: function(){
        getPermission(this);
        var dictGroupCodes = "SEVERITY_DICT,AUDIT_STATUS_DICT,PROGRAM_TYPE_DICT,PROGRAM_LEVEL_DICT,PROGRAM_STATE_DICT,PROGRAM_CONTENT_TYPE,YANLIAN_STRATEGY_TYPE,PROGRAM_STRATEGY_TYPE";
...
function reload() {
    ...
    $("#jqGrid").jqGrid('setGridParam',{
        postData:{"programName":vm.req.programName,"programType":vm.req.programType,"auditResult":vm.req.auditResult,"startCreateTime":startTime,"endStartCreateTime":endTime},
        page:page
    }).trigger("reloadGrid");
}
