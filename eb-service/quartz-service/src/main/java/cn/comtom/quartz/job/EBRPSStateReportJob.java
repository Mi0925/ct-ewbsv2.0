...
public class EBRPSStateReportJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("=====平台资源状态信息主动上报开始====[{}]",new Date());

        ApiResponse response = linkageService.ebrpsStateReport();

        log.info("=====平台资源状态信息主动上报结束====[{}],result=[{}]",new Date(),response.getSuccessful());
