...
public class EBRASInfoReportJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("=====应急广播适配器资源信息上报开始====[{}]",new Date());

        ApiResponse response = linkageService.ebrasInfoReport();

        log.info("=====应急广播适配器资源信息上报上报结束====[{}],result=[{}]",new Date(),response.getSuccessful());
    }
}
