...
public class EBRBSInfoReportJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("=====播出资源上报开始====[{}]",new Date());

        ApiResponse response = linkageService.ebrbsInfoReport();

        log.info("=====播出资源上报上报结束====[{}],result=[{}]",new Date(),response.getSuccessful());
    }
}
