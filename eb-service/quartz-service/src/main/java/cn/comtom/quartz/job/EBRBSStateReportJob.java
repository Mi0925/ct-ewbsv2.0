...
public class EBRBSStateReportJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("=====播出资源状态信息主动上报开始====[{}]",new Date());

        ApiResponse response = linkageService.ebrbsStateReport();

        log.info("=====播出资源状态信息主动上报结束====[{}],result=[{}]",new Date(),response.getSuccessful());
