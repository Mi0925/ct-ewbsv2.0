...
public class EBRPSInfoReportJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("=====平台资源上报开始====[{}]",new Date());

        ApiResponse response = linkageService.ebrpsInfoReport();

        log.info("=====平台资源上报上报结束====[{}],result=[{}]",new Date(),response.getSuccessful());
    }
}
