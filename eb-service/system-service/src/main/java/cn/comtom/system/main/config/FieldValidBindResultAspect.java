...
import cn.comtom.system.fw.FieldValidError;
...
public class FieldValidBindResultAspect {
    ...
    @Pointcut(value = "execution(* cn.comtom.system..*.controller..*Controller.*(..,org.springframework.validation.BindingResult,..))")
    public void validPointCut() {

    }

	@Before(value="validPointCut()" )
	public void valid(JoinPoint joinPoint) throws FieldValidErrorException {
        //请求的参数
