...
public interface SystemFegin {
    ...
    ApiPageResponse<SysUserInfo> findUserPage(@RequestParam Map<String,Object> whereRequestMap);
    ...
    @PutMapping(value = "/system/region/area/updateOrSaveArea")
	public ApiResponse updateOrSaveArea(@RequestBody RegionAreaInfo regionArea);

    @DeleteMapping(value = "/system/region/area/deleteAreaById/{id}")
	public ApiResponse deleteAreaById(@PathVariable(name = "id")String id);

    @RequestMapping(value = "/system/org/get/{id}",method = RequestMethod.GET)
	public ApiEntityResponse<OrganizationInfo> getOrgInfoById(@PathVariable(name = "id")String id);

    @RequestMapping(value = "/system/org/page",method = RequestMethod.GET)
	public ApiPageResponse<OrganizationInfo> getOrgInfoByPage(@RequestParam Map<String, Object> whereRequestMap);

    @PostMapping(value = "/system/org/save")
	public ApiEntityResponse<OrganizationInfo> saveOrgInfo(@RequestBody OrganizationInfo request);

    @PutMapping(value = "/system/org/update")
	public ApiResponse updateOrgInfo(@RequestBody OrganizationInfo request);

    @DeleteMapping(value = "/system/org/delete/{id}")
	public ApiResponse deleteOrgInfo(@PathVariable(name = "id")String id);
