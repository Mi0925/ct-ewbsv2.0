...
public interface ResoFegin {
	...
	ApiEntityResponse<EbrAdapterInfo> getEbrAdapterInfoById(@PathVariable(value = "ebrId") String ebrId);
    
    @GetMapping(value = "/res/ebr/adapter/page")
	ApiPageResponse<EbrAdapterInfo> getEbrAdapterInfoByPage(@RequestParam Map<String, Object> whereRequestMap);
    
    @PostMapping(value = "/res/ebr/adapter/save")
	ApiEntityResponse<EbrAdapterInfo> saveEbrAdapterInfo(@RequestBody AdapterAddRequest request);
    
    @PutMapping(value = "/res/ebr/adapter/update")
	ApiResponse updateEbrAdapterInfo(@RequestBody AdapterUpdateRequest request);
	
	@DeleteMapping(value = "/res/ebr/adapter/delete/{ebrId}")
	ApiResponse deleteEbrAdapterInfo(@PathVariable(value = "ebrId") String ebrId);
	
	@RequestMapping(value = "/res/ebr/station/{ebrId}",method = RequestMethod.GET)
	ApiEntityResponse<EbrStationInfo> getEbrStationInfoById(@PathVariable(value = "ebrId") String ebrId);
	
	@GetMapping(value = "/res/ebr/station/page")
	ApiPageResponse<EbrStationInfo> getEbrStationInfoByPage(@RequestParam Map<String, Object> whereRequestMap);
	
	@PostMapping(value = "/res/ebr/station/save")
	ApiEntityResponse<EbrStationInfo> saveEbrStationInfo(@RequestBody StationAddRequest request);
	
	@PutMapping(value = "/res/ebr/station/update")
	ApiResponse updateEbrStationInfo(@RequestBody StationUpdateRequest request);
	
	@DeleteMapping(value = "/res/ebr/station/delete/{ebrId}")
	ApiResponse deleteEbrStationInfo(@PathVariable(value = "ebrId") String ebrId);
	
	@GetMapping(value = "/res/ebr/station/findStationListByWhere")
	ApiPageResponse findStationListByWhere(@RequestParam Map<String, Object> whereRequestMap);
	
	@GetMapping(value = "/res/ebr/manufacturer/{id}")
	ApiEntityResponse<EbrManufacturerInfo> getEbrManufactInfoById(@PathVariable(value = "id") String id);

	@GetMapping(value = "/res/ebr/manufacturer/page")
	ApiPageResponse<EbrManufacturerInfo> getEbrManufacturerInfoByPage(@RequestParam Map<String, Object> whereRequestMap);
	
	@PostMapping(value = "/res/ebr/manufacturer/save")
	ApiEntityResponse<EbrManufacturerInfo> saveEbrManufacturerInfo(@RequestBody  EbrManufacturerInfo request);

	@PutMapping(value = "/res/ebr/manufacturer/update")
	ApiResponse updateEbrManufacturerInfo(@RequestBody EbrManufacturerInfo request);

	@DeleteMapping(value = "/res/ebr/manufacturer/delete/{id}")
	ApiResponse deleteEbrManufacturerInfo(@PathVariable(value = "id")String ebrId);
	
	@GetMapping(value = "/res/ebr/getFailureRate/{resType}")
	ApiEntityResponse<Double> getFailureRate(@PathVariable(value = "resType")String resType);
}
