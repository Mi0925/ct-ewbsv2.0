...
import cn.comtom.core.main.fegin.service.impl.SystemFeginServiceImpl;
...
public class TTSComponent {
    ...
    public Integer getProgramContentSpeechLength(String content) {
        try {
            //文转语音，计算播放需要的时长
            this.getInstance();
            SysParamsInfo byKey = systemFeginService.getByKey(Constants.TEMP_FILE_PATH);
            String dirPath=byKey.getParamValue()+"/tts/";
