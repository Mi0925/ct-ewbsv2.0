...
import cn.comtom.core.main.fegin.SystemFegin;
...
public class SystemFeginServiceImpl extends FeginBaseService implements ISystemFeginService {
    ...
    @Override
    public List<SysUserInfo> findUserPage(UserPageRequest pageRequest) {
        Map<String,Object> whereRequestMap = ReflectionUtils.convertBean2Map(pageRequest);
        return getData(systemFegin.findUserPage(whereRequestMap));
    }
